class ADC_Op():
    ...
    value_second = 0
    operation = ''
    def __init__(self, is_carry_set: bool, value_A: int, value_second: int, operation: str):
...
class AddWithCarry0x61(ADC_Op):
    def __init__(self, carry: bool, X: str, index: int, value_A: int, operation: str):
        super().__init__(self, carry, valueA, X[index], "Op 61")


class AddWithCarry0x65(ADC_Op):
    def __init__(self, carry: bool, zpg_index: int, value_A: int, operation: str):
        super().__init__(self, carry, valueA, zpg_index, "Op 65")


class AddWithCarry0x69(ADC_Op):
    def __init__(self, carry: bool, imm: int, value_A: int, operation: str):
        super().__init__(self, carry, valueA, imm, "Op 69")


class AddWithCarry0x6D(ADC_Op):
    def __init__(self, carry: bool, abs: int, value_A: int, operation: str):
        super().__init__(self, carry, valueA, abs, "Op 6D")

class AddWithCarry0x71(ADC_Op):
    def __init__(self, carry: bool, index: int, Y: int, value_A: int, operation: str):
        super().__init__(self, carry, valueA, Y[índex], "Op 71")

class AddWithCarry0x75(ADC_Op):
    def __init__(self, carry: bool, zpg_index: int, X: int, value_A: int, operation: str):
        super().__init__(self, carry, valueA, zpg_index[X], "Op 75")

class AddWithCarry0x79(ADC_Op):
    def __init__(self, carry: bool, abs: int, Y: int, value_A: int, operation: str):
        super().__init__(self, carry, valueA, abs[Y], "Op 79")

class AddWithCarry0x7D(ADC_Op):
    def __init__(self, carry: bool, abs: int, X: int, value_A: int, operation: str):
