...
def teste(pixels, pixels_2, pixels_3, pixels_4, array_flags, pos):
    ...
    first_sprite = ppu.build_sprite(sprites, pos, array_flags)
    second_sprite = ppu.build_sprite(sprites, pos, array_flags)
    ...
    while 1:
        ...
        ppu.update_sprite(first_sprite[0], [10, 0], [ppu.x_limit_position, ppu.y_limit_position])
        ppu.update_sprite(first_sprite[1], [10, 0], [ppu.x_limit_position, ppu.y_limit_position])
        ppu.update_sprite(first_sprite[2], [10, 0], [ppu.x_limit_position, ppu.y_limit_position])
        ppu.update_sprite(first_sprite[3], [10, 0], [ppu.x_limit_position, ppu.y_limit_position])
